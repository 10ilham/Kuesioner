            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Pertanyaan Kuesioner Layanan Akademik</h3>
                    </div>
                    ...
                    <form action="" method="post" class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="pertanyaan" name="pertanyaan" value="<?php echo set_value('pertanyaan');echo $kuesioner['pertanyaan'] ?>" placeholder="Masukkan Pertanyaan *">
                        ...
                        <div class="box-footer">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="<?php echo site_url('manajemen_kuesioner/akademik'); ?>" button type="submit" class="btn btn-warning"><i class="fa fa-rotate-left"></i> Kembali</a>
