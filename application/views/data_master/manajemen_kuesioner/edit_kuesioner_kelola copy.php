                    ...
                    <form action="" method="post" class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="bagian" name="bagian" value="<?php echo set_value('bagian', isset($kuesioner['bagian']) ? $kuesioner['bagian'] : ''); ?>" placeholder="Dosen" disabled>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-12">
                                    <select class="form-control" name="bagian">
                                        <option value="Dosen" <?= ($kuesioner['id_level'] == 2) ? "selected" : "" ?>>Dosen</option>
                                        <option value="Tenaga Kependidikan" <?= ($kuesioner['id_level'] == 3) ? "selected" : "" ?>>Tenaga Kependidikan</option>
                                    </select>
                                    <?php echo form_error('bagian', '<small class="text-danger pl-3">', '</small>') ?>
                                </div>
                            </div> -->
