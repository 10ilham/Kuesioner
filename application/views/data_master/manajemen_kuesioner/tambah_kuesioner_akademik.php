            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Pertanyaan Kuesioner Layanan Akademik</h3>
                    </div>

                    <!-- Form -->
                    <br />
                    <form action="<?php echo site_url('manajemen_kuesioner/akademik/tambah'); ?>" method="post" class="form-horizontal">
                        <div class="box-body">
