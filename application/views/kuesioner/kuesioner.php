                            ...
                            <div class="box box-primary">
                                <div class="box-body">
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" required id="editor" name="textharapan" value="<?php echo set_value('harapan'); ?>" placeholder="Masukan Harapan Saudara*"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" required id="editor1" name="textmasukan" value="<?php echo set_value('masukan'); ?>" placeholder="Masukan Saran Saudara*"></textarea>
                                    ...
                                    <div class="col-lg-4 col-xs-6">
                                        ...
                                        <div class="small-box bg-green">
                                            <div class="inner">
                                                ...
                                                <br>
                                                <br>
                                                <h3 class="text-center"><?= number_format(min((($ws / 4) / (100 / 100) * 100), 100), 2) ?><sup style="font-size: 20px">%</sup>
                                                </h3>
